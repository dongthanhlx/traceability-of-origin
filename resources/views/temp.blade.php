        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.code">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" x-model="customer.is_active">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.patient">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="date" class="form-control" x-model="customer.birthday">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" x-model="customer.phone">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.doctor">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.dentistry">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.lab">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.type">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" class="form-control" x-model="customer.num_of_teeth">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" x-model="customer.locations">
                    </div>
                </div>
